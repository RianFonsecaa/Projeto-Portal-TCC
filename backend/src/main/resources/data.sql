...
tipo_curso, tipo_projeto, orientando_id, orientador_id, tcc_id) VALUES
...
INSERT INTO public.tarefa (id, data_envio, data_fim, descricao, nome_tarefa, orientador_id, orientando_id, status, projeto_id, prioridade, classificacao, alerta, prazo)
VALUES (1, '2024-02-10', '2024-02-20', 'Finalizar a mockagem das classes', 'Mock das Classes', 1, 2, 'PENDENTE', 1, 'ALTA', 'DESENVOLVIMENTO', false, '2024-02-18'),
